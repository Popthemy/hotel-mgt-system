"""
Django settings for hotel_mgt_sys project.
...
SECRET_KEY = 'django-insecure-ah!p(dv9^&5a#6vt7*ptt))7gmabq1o-eo*4*s=v*o!nrvj@ij'
...
WSGI_APPLICATION = 'hotel_mgt_sys.wsgi.application'
